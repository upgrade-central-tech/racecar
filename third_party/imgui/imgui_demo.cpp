...
static ExampleTreeNode* ExampleTree_CreateDemoTree() {
    static const char* root_names[] = { "Apple",      "Banana",    "Cherry", "Kiwi",
...
static void DemoWindowWidgetsColorAndPickers() {
    ...
    if ( ImGui::TreeNode( "Color/Picker Widgets" ) ) {
        ...
        ImGui::Combo(
            ...
            "Auto/"
            "Current\0ImGuiColorEditFlags_PickerHueBar\0ImGuiColorEditFlags_PickerHueWheel\0" );
        ImGui::SameLine();
        HelpMarker(
...
// hence the /2.
        ...
        ImGui::SliderScalar( "slider s16 full", ImGuiDataType_S16, &s16_v, &s16_min, &s16_max,
                             "%d" );
        ImGui::SliderScalar( "slider u16 full", ImGuiDataType_U16, &u16_v, &u16_min, &u16_max,
                             "%u" );
        ...
        ImGui::SliderScalar( "slider s32 high", ImGuiDataType_S32, &s32_v, &s32_hi_a, &s32_hi_b,
                             "%d" );
        ImGui::SliderScalar( "slider s32 full", ImGuiDataType_S32, &s32_v, &s32_min, &s32_max,
                             "%d" );
        ...
        ImGui::SliderScalar( "slider u32 high", ImGuiDataType_U32, &u32_v, &u32_hi_a, &u32_hi_b,
                             "%u" );
        ImGui::SliderScalar( "slider u32 full", ImGuiDataType_U32, &u32_v, &u32_min, &u32_max,
                             "%u" );
    ...
    if ( ImGui::TreeNode( "Images" ) ) {
...

        {
            ...
            if ( ImGui::BeginItemTooltip() ) {
                ...
                ImGui::ImageWithBg( my_tex_id, ImVec2( region_sz * zoom, region_sz * zoom ), uv0,
...
static void DemoWindowWidgetsPlotting() {
    ...
    if ( ImGui::TreeNode( "Plotting" ) ) {
        ...
        ImGui::PlotLines( "Lines##2", func, NULL, display_count, 0, NULL, -1.0f, 1.0f,
                          ImVec2( 0, 80 ) );
...
struct ExampleSelectionWithDeletion : ImGuiSelectionBasicStorage {
    ...
    int ApplyDeletionPreLoop( ImGuiMultiSelectIO* ms_io, int items_count ) {
        ...
        if ( ms_io->NavIdSelected ==
             false )  // This is merely a shortcut, == Contains(adapter->IndexToStorage(items,
                      // focused_idx))
        {
            ms_io->RangeSrcReset =
    ...
    void MoveSelected( int src, int dst ) {
        for ( int src_n = 0; src_n < Items[src].Size; src_n++ ) {
            ...
            if ( !Selections[src].Contains( item_id ) )
                continue;
            Items[src].erase( &Items[src][src_n] );  // FIXME-OPT: Could be implemented more
        ...
        if ( ImGui::TreeNode( "Multi-Select (checkboxes)" ) ) {
            ...
            ImGui::CheckboxFlags(
                ...
                ImGuiMultiSelectFlags_BoxSelect2d );  // Cannot use
                                                      // ImGuiMultiSelectFlags_BoxSelect1d as
...
static void DemoWindowWidgetsText() {
    ...
    if ( ImGui::TreeNode( "Text" ) ) {
        ...
        if ( ImGui::TreeNode( "Font Size" ) ) {
            ...
            ImGui::Text( "FontSize = %.2f (== %.2f * global_scale)", ImGui::GetFontSize(),
                         custom_size );
            ImGui::PopFont();
...
static void DemoWindowWidgetsTextInput() {
    ...
    if ( ImGui::TreeNode( "Text Input" ) ) {
        ...
        if ( ImGui::TreeNode( "Filtered Text Input" ) ) {
            ...
            static char buf3[32] = "";
            ImGui::InputText(
                "hexadecimal", buf3, IM_ARRAYSIZE( buf3 ),
...
static void DemoWindowLayout() {
    ...
    if ( ImGui::TreeNode( "Scrolling" ) ) {
        ...
        if ( show_horizontal_contents_size_demo_window ) {
            ...
            ImGui::Checkbox( "Tree nodes", &show_tree_nodes );  // Will grow contents size and
                                                                // display highlight over full width
    ...
    if ( ImGui::TreeNode( "Text Clipping" ) ) {
        ...
        for ( int n = 0; n < 3; n++ ) {
            ...
            ImGui::PopID();
            if ( !ImGui::IsItemVisible() )  // Skip rendering as ImDrawList elements are not
                                            // clipped.
                continue;
...
static void DemoWindowTables() {
        ...
        for ( int n = 0; n < 3; n++ ) {
            ...
            if ( open &&
                ...
                const int cell_count =
                    ( n == 1 ) ? 27
                               : 9;  // Make second table have a scrollbar to verify that additional
    ...
    if ( ImGui::TreeNode( "Advanced" ) ) {
        ...
        if ( ImGui::BeginTable( "table_advanced", 6, flags,
            ...
            ImGui::TableSetupColumn(
                "Quantity", columns_base_flags | ImGuiTableColumnFlags_PreferSortDescending, 0.0f,
                MyItemColumnID_Quantity );
            ImGui::TableSetupColumn(
                "Description",
...
void ImGui::ShowStyleEditor( ImGuiStyle* ref ) {
    ...
    if ( BeginTabBar( "##tabs", ImGuiTabBarFlags_None ) ) {
        if ( BeginTabItem( "Sizes" ) ) {
            ...
            DragFloat( "TabCloseButtonMinWidthSelected", &style.TabCloseButtonMinWidthSelected,
                       0.5f, -1.0f, 100.0f,
                       ( style.TabCloseButtonMinWidthSelected < 0.0f ) ? "%.0f (Always)" : "%.0f" );
            DragFloat(
                "TabCloseButtonMinWidthUnselected", &style.TabCloseButtonMinWidthUnselected, 0.5f,
                -1.0f, 100.0f,
            ...
            SliderAngle( "TableAngledHeadersAngle", &style.TableAngledHeadersAngle, -50.0f,
                         +50.0f );
            SliderFloat2( "TableAngledHeadersTextAlign", (float*)&style.TableAngledHeadersTextAlign,
                          0.0f, 1.0f, "%.2f" );
            ...
            SliderFloat( "WindowBorderHoverPadding", &style.WindowBorderHoverPadding, 1.0f, 20.0f,
                         "%.0f" );
...
struct ExampleAssetsBrowser {
    ...
    void Draw( const char* title, bool* p_open ) {
        ...
        ImGui::SetNextWindowContentSize( ImVec2(
            0.0f,
            LayoutOuterPadding + LayoutLineCount * ( LayoutItemSize.y + LayoutItemSpacing ) ) );
        if ( ImGui::BeginChild( "Assets", ImVec2( 0.0f, -ImGui::GetTextLineHeightWithSpacing() ),
            ...
            start_pos =
                ImVec2( start_pos.x + LayoutOuterPadding, start_pos.y + LayoutOuterPadding );
