...
VkDescriptorSetLayout build( vk::Common& vulkan, DescriptorLayoutBuilder& ds_layout_builder,
    VkShaderStageFlags shader_stage_flags, VkDescriptorSetLayoutCreateFlags layout_create_flags )
{
    ...
    vk::Common& vulkan, const DescriptorAllocator& ds_allocator, VkDescriptorSetLayout layout )
{
    ...
    /// TODO: add destructor
    // vulkan.destructor_stack.push( vulkan.device, descriptor_set, vkFreeDescriptorSets );
