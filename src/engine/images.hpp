...
vk::mem::AllocatedImage create_image( void* data,
    VkExtent3D size, VkFormat format, VkImageType image_type, VkImageUsageFlags usage_flags,
    bool mipmapped );

vk::mem::AllocatedImage allocate_image( VkExtent3D extent, VkFormat format,
...
vk::mem::AllocatedImage load_image( std::filesystem::path file_path,
    size_t desired_channels, VkFormat image_format, bool is_mipmapped );
