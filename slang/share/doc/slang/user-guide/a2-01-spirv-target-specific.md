...
```
../../slang/bin/slangc.exe test.slang -target spir-v -profile spir-v_1_5 # emits OpKill 
../../slang/bin/slangc.exe test.slang -target spir-v -profile spir-v_1_6 # emits OpDemoteToHelperInvocation 
../../slang/bin/slangc.exe test.slang -target spir-v -capability SPV_EXT_demote_to_helper_invocation -profile spir-v_1_5 # emits OpDemoteToHelperInvocation 
```
