...
slangc.exe "$PSScriptRoot\cloud_debug.slang" -target spirv -profile spirv_1_4 -g2 -emit-spirv-directly -fvk-use-entrypoint-name -entry vs_main -entry fs_main -o "$PSScriptRoot\cloud_debug.spv"
