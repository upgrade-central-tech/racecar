...
slangc.exe "$PSScriptRoot\terrain_lighting.slang" @CommonArgs -emit-spirv-directly -fvk-use-entrypoint-name -entry cs_terrain_draw  -capability SPV_EXT_shader_atomic_float_add -o "$PSScriptRoot\cs_terrain_draw.spv"
