...
slangc.exe "$PSScriptRoot\cloud_composite.slang" -target spirv -profile spirv_1_5 -emit-spirv-directly -fvk-use-entrypoint-name -entry vs_main -entry fs_main -o "$PSScriptRoot\cloud_composite.spv"